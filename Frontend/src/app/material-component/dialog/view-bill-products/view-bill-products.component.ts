...
export class ViewBillProductsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    try {
      ...
      console.error('Error parsing product detail JSON:', error);
      // Handle the error gracefully, such as assigning a default or empty value to dataSource.
      // Example: this.dataSource = [];
    }
