...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try{
            ...
            if(validateRequestMap(requestMap)){
                ...
                PdfWriter.getInstance(document,new FileOutputStream(RestaurantConstant.STORE_LOCATION + "\\" + fileName + ".pdf"));
                document.open();
                setRestangleInPdf(document);
    ...
    private void setRestangleInPdf(Document document) throws DocumentException {
        log.info("Inside setRestangleInPdf");
        Rectangle rect= new Rectangle(577,825,18,15);
        rect.enableBorderSide(1);
        rect.enableBorderSide(2);
        rect.enableBorderSide(4);
        rect.enableBorderSide(18);
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        ...
        try {
            ...
            String filePath = RestaurantConstant.STORE_LOCATION + "\\" + (String) requestMap.get("uuid") + ".pdf";
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try {
            ...
            if (!optional.isEmpty()) {
                ...
                return RestaurantUtils.getResponseEntity("Deleted successfully", HttpStatus.INTERNAL_SERVER_ERROR);
            }
